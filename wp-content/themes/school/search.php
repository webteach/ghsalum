<?php get_header(); ?>
    <div id="kt-main" role="main">
        ...
        <div class="row" id="kt-blog-title">
            ...
            <div class="col-md-11">
            <h1><?php echo __('Search Results','school'); ?></h1>
            <span class="small">
            <a href="<?php echo esc_url(home_url());?>">                                         
            <?php echo __('Home','school');?></a> / <?php echo __('Search Results','school');?></span>
            </div>
        </div>
            <div class="row">
                <!-- Main Content -->
                    ...
                    <div <?php post_class('kt-article'); ?>>
                        <div class="row">
                            <!-- Main Blog Post -->
                                ...
                                <a class="btn btn-primary kt-read-more-link"><?php echo __('Read More..','school'); ?></a>
                                </div>
                            <!-- Main Blog Post Ends -->
                        </div>
                    </div>
